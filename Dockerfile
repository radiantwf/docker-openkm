...
RUN curl -L https://jaist.dl.sourceforge.net/project/openkm/6.3.2/openkm-6.3.2-community-tomcat-bundle.zip -o /usr/local/openkm.zip && \
    unzip /usr/local/openkm.zip -d /usr/local/ && \
